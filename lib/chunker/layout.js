      ...
      if ((0, _dom.isElement)(container)) {
        ...
        if ((0, _dom.isElement)(temp)) {
          ...
          if (!renderedNode) {
            ...
            renderedNode = (0, _dom.findElement)((0, _dom.prevValidElement)(temp), rendered); // Check if temp is the last rendered node at its level.
          ...
          if (!renderedNode) {
            renderedNode = (0, _dom.findElement)((0, _dom.prevValidElement)(container), rendered);
          }
        ...
        if (!renderedNode) {
          renderedNode = (0, _dom.findElement)((0, _dom.prevValidElement)(container.parentNode), rendered);
        }
        ...
        if (node) {
          ...
          if (!range && left >= end) {
            ...
            if ((0, _dom.isElement)(node)) {
              ...
              prev = breakAvoid && (0, _dom.displayedElementBefore)(node, rendered);
